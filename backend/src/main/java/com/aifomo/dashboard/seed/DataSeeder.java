...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedSources() {
        List<SourceSeed> sources = List.of(
                new SourceSeed("Choi OpenAI", SourceType.THREADS, SourceCategory.NEWS, "https://www.threads.com/@choi.openai", "Threads AI news curation", true),
                new SourceSeed("UncleJobs AI", SourceType.THREADS, SourceCategory.NEWS, "https://www.threads.com/@unclejobs.ai", "Threads AI news curation", true),
                new SourceSeed("Appcast", SourceType.THREADS, SourceCategory.CODEX, "https://www.threads.com/@appcast", "Codex and developer workflow threads", true),
                new SourceSeed("Ethan CL", SourceType.THREADS, SourceCategory.CODEX, "https://www.threads.com/@ethancl", "Codex and automation threads", true),
                new SourceSeed("GPTaku AI", SourceType.THREADS, SourceCategory.CLAUDE, "https://www.threads.com/@gptaku_ai", "Claude and AI coding threads", true),
                new SourceSeed("Roach Log", SourceType.THREADS, SourceCategory.HERMES, "https://www.threads.com/@roach_log", "Hermes and local AI workflow threads", true),
                new SourceSeed("Specal1849", SourceType.THREADS, SourceCategory.IMAGE, "https://www.threads.com/@specal1849", "Image AI threads", true),
                new SourceSeed("Xazinga", SourceType.THREADS, SourceCategory.VIDEO, "https://www.threads.com/@xazinga", "Video AI threads", true),
                new SourceSeed("Apple Tea 94", SourceType.THREADS, SourceCategory.VIDEO, "https://www.threads.com/@apple_tea_94", "Video AI threads", true),
                new SourceSeed("OpenAI Official Blog", SourceType.OFFICIAL_BLOG, SourceCategory.COMPANY_OFFICIAL, "https://openai.com/blog", "Future official source", false),
                new SourceSeed("Anthropic News", SourceType.OFFICIAL_BLOG, SourceCategory.COMPANY_OFFICIAL, "https://www.anthropic.com/news", "Future official source", false),
                new SourceSeed("Google AI Blog", SourceType.OFFICIAL_BLOG, SourceCategory.COMPANY_OFFICIAL, "https://ai.googleblog.com", "Future official source", false)
        );

        sources.forEach(seed -> sourceRepository.findByUrl(seed.url())
                .orElseGet(() -> sourceRepository.save(new Source(
                        seed.name(),
                        seed.sourceType(),
                        seed.category(),
                        seed.url(),
